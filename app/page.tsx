...
const HEALTH_APPS: App[] = [
  {
    ...
    role: "체성분 · 피검사 기록",
    description:
      "인바디와 피검사 결과지를 찍으면 인쇄된 항목을 모두 읽어 날짜별로 쌓아둬요. 적정 범위와 겹쳐 지금 위치를 보여주고, 벗어난 수치에는 운동·식습관 권장사항을 근거와 함께 붙여요. 어떤 진료지침에서 나온 말인지 펼쳐볼 수 있어요.",
    chips: ["인바디 자동 판독", "피검사 판독", "근거 있는 권장사항", "항목별 추이"],
  },
];
