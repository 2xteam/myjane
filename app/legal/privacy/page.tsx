    ...
    >
      ...
      <LegalSection tint title="6. 이용자와 법정대리인의 권리">
        ...
        <div className="legal-callout">
          ...
          <p>
            <strong>
              현재 만 14세 미만 아동의 가입은 받지 않습니다.
            </strong>{" "}
            가입 시 법정대리인의 동의를 확인하는 절차가 아직 준비되지 않았기
            때문입니다. 만 14세 미만 아동께서는 가입하지 마시고, 보호자께서
            대신 이용해 주시기 바랍니다.
          </p>
          <p>
            앞으로는 <strong>보호자 계정에 자녀를 추가하는 방식</strong>을
            준비하고 있습니다. 보호자가 가입해 로그인한 뒤 자녀를 추가하면
            자녀의 기록이 보호자 계정에 연결되어 따로 만들어지고, 자녀에게
            별도의 로그인 수단을 두지 않아 아동에게서 연락처를 직접 받지
            않는 방식입니다. <strong>아직 만들어지지 않았습니다.</strong>
          </p>
          <p>
            준비되면 자녀를 추가하실 때 법정대리인 동의를 따로 받고 그 시각을
            기록합니다 →{" "}
      ...
      <LegalSection title="7. 안전조치">
        <ul>
          ...
          <li>
            로그인 상태를 확인하는 값에 서명을 붙여, 다른 사람의 기록에 접근하지
            못하도록 서버에서 검증합니다
          </li>
          <li>
