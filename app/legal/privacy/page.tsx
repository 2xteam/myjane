    ...
    >
      ...
      <LegalSection tint title="6. 이용자와 법정대리인의 권리">
        ...
        <div className="legal-callout">
          ...
          <p>
            만 14세 미만 아동은 <strong>본인 명의로 가입하지 않습니다.</strong>{" "}
            보호자가 가입해 로그인하신 뒤 그 계정 안에서{" "}
            <strong>자녀를 추가</strong>하시면, 자녀의 기록이 보호자 계정에
            연결되어 따로 만들어집니다.
          </p>
          <ul>
            <li>
              <strong>로그인은 보호자 계정 하나로 합니다.</strong> 로그인하신
              뒤 본인 또는 자녀를 골라 들어갑니다
            </li>
            <li>
              자녀에게 별도의 로그인 수단을 두지 않으므로{" "}
              <strong>아동에게서 이메일이나 전화번호를 받지 않습니다.</strong>{" "}
              자녀에 대해 저장되는 것은 보호자가 입력하신 이름과 그 자녀의 앱
              이용 기록입니다
            </li>
            <li>
              보호자와 자녀, 그리고 형제자매는 서로 친구로 맺어진 상태로
              만들어집니다
            </li>
            <li>
